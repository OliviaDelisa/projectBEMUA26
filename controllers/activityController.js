...
// 1. Ambil semua kegiatan untuk admin (Sesuai statistik di Stats Card)
...
// 2. Buat kegiatan baru — dengan validasi input lengkap
exports.createActivity = (req, res) => {
    ...
    today.setHours(0, 0, 0, 0); // abaikan jam, hanya bandingkan tanggal
...
// 4. Hapus kegiatan (Untuk fitur Hapus pada status 'mendatang')
exports.deleteActivity = (req, res) => {
    const { id } = req.params;

    // Database MySQL akan otomatis menghapus di activity_attendance jika menggunakan ON DELETE CASCADE pada Foreign Key
...
exports.scanAttendance = (req, res) => {
    ...
    // Cari kegiatan berdasarkan kode_qr dan pastikan sedang berlangsung
    const findQuery = `
    ...
    db.query(findQuery, [kode_qr], (err, activities) => {
        ...
        // Validasi waktu — kegiatan harus sedang berlangsung
        // Diberi toleransi 30 menit sebelum mulai agar user bisa absen lebih awal
        ...
        // Cek apakah user terdaftar sebagai peserta kegiatan ini
        const checkQuery = `
            SELECT id, status 
