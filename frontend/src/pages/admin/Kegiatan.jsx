            ...
            <div className="kg-card-header">
              <div className="kg-card-title">
                ...
                {activeFilter === 'semua' ? 'Semua Kegiatan' :
                 ...
                 'Kegiatan Selesai'}
                <span style={{fontSize:'12px', fontWeight:300, color:'var(--muted)'}}>({filteredKegiatan.length} kegiatan)</span>
              </div>
              ...
              <div style={{padding:'24px'}}>
                {currentStep === 1 ? (
                  <div className="kg-form-grid">
                    ...
                    <div className="kg-form-group full">
                      <label className="kg-form-label">Deskripsi <span style={{fontWeight:400, textTransform:'none', fontSize:'11px', color:'var(--muted)'}}></span></label>
                  ...
                  <div>
                    ...
                    <div className="kg-form-group" style={{marginBottom:'10px'}}>
                      <label className="kg-form-label">
                        Nama Lokasi *{' '}
                        {reverseLoading && <span style={{fontWeight:300, textTransform:'none', fontSize:'11px', color:'var(--g600)', marginLeft:'8px'}}>⏳ Mendeteksi lokasi...</span>}
                      </label>
                      <input
                    ...
                    <div style={{marginBottom:'8px'}}>
                      <div style={{fontSize:'10px', fontWeight:300, color:'var(--muted)', textTransform:'uppercase', letterSpacing:'0.05em', marginBottom:'6px', display:'flex', alignItems:'center', gap:'6px'}}>
